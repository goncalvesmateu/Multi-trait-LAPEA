...
- Multi-trait models can be useful for increasing prediction accuracy when the traits of interest are not measured in the individuals of the testing set, but were observed in individuals in the training set [@jia2012multiple].
